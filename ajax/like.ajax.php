...
if(isset($_GET['type']) && isset($_GET['id'])){
    ...
    if(isset($_SESSION['diddit_userid'])){
        ...
        $sql = "select endorsements from endorsements where type='post' && contentid = '$_GET[id]' limit 1";
        $result = $DB->read($sql);
        if(is_array($result)){
    ...
    if($like_count > 0){
        ...
        if($like_count == 1){
            ...
            if($i_liked){
                $info .= "<div style='text-align:left;'>You endorsed this post</div>";
            }else{
                $info .= "<div style='text-align:left;'>1 person endorsed this post</div>";
            }
        }else{
            ...
            if($i_liked){
                ...
                $info .= "<div style='text-align:left;'>You and " . ($like_count - 1) . " $text endorsed this post</div>";
            }else{
                $info .= "<div style='text-align:left;'>" . $like_count . " people endorsed this post</div>";
            }
        }

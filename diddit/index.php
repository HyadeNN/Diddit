...
<!DOCTYPE html>
	...
	<body style="font-family: tahoma; background-color: #1A282D;">
			...
			<div style="display: flex;">	
				...
				<!--posts area-->
 				<div style="min-height: 400px;flex:2.5;padding: 20px;padding-right: 0px;">
 					...
 					<div style="border:solid thin #aaa; padding: 10px;background-color: #1A282D;">

 						<form method="post" enctype="multipart/form-data">

	 						<textarea name="post" placeholder="Welcome to the place that no one likes Frontend Devs. "></textarea>

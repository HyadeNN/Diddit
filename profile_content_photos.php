<div style="min-height: 400px;width:100%;background-color: #04161c;text-align: center;">
	...
	<?php
		...
		if(is_array($images)){
			...
			foreach ($images as $image_row) {
				# code...
				echo "<a style='border-radius: 10px;' href='single_post.php?id=$image_row[postid]' >";
